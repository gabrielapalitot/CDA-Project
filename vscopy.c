...
/* instruction fetch 
in mips, its inverted where 1 = false and 0 = true, remember that when creating
...
/* Read Register 
Just basically reads the register value and assigns to the corresponding pointer r1 or r2*/
/* 5 Points */
...
/* Sign Extend 
basically if the number is positive, fill the 32 bits with 0s and if negative fill with 1s (like we talked in person)*/
/* 10 Points */
